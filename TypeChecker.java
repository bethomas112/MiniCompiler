...
public class TypeChecker extends TreeParser {
	...
	// TypeChecker.g:306:1: return_stmt[FunctionPrototype proto, HashMap<String, MiniType> typeEnv] returns [\n boolean hasReturn = true\n ] : ^(ast= RETURN (e= expression[typeEnv] )? ) ;
	public final boolean return_stmt(FunctionPrototype proto, HashMap<String, MiniType> typeEnv) throws RecognitionException {
		...
		try {
			// TypeChecker.g:315:4: ( ^(ast= RETURN (e= expression[typeEnv] )? ) )
			// TypeChecker.g:315:7: ^(ast= RETURN (e= expression[typeEnv] )? )
			{
			ast=(CommonTree)match(input,RETURN,FOLLOW_RETURN_in_return_stmt1455); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// TypeChecker.g:315:20: (e= expression[typeEnv] )?
				int alt16=2;
				...
				switch (alt16) {
					case 1 :
						// TypeChecker.g:315:21: e= expression[typeEnv]
						{

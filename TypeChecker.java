// $ANTLR 3.3 Nov 30, 2010 12:50:56 TypeChecker.g 2015-04-20 19:10:52
...
public class TypeChecker extends TreeParser {
    ...
    // TypeChecker.g:57:1: translate returns [MiniType miniType = null] : ^( PROGRAM t= types d= declarations[globalTypeEnv] f= functions ) ;
    public final MiniType translate() throws RecognitionException {
        ...
        try {
            // TypeChecker.g:59:4: ( ^( PROGRAM t= types d= declarations[globalTypeEnv] f= functions ) )
            // TypeChecker.g:59:7: ^( PROGRAM t= types d= declarations[globalTypeEnv] f= functions )
            {
    ...
    // $ANTLR start "types"
    // TypeChecker.g:67:1: types returns [MiniType miniType = null] : ( ^( TYPES (t= type_decl )* ) | );
    public final MiniType types() throws RecognitionException {
        ...
        try {
            // TypeChecker.g:70:4: ( ^( TYPES (t= type_decl )* ) | )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // TypeChecker.g:70:7: ^( TYPES (t= type_decl )* )
                    {
                    match(input,TYPES,FOLLOW_TYPES_in_types117); 

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); 
                        // TypeChecker.g:70:15: (t= type_decl )*
                        loop1:
                        do {
                            int alt1=2;
                            ...
                            switch (alt1) {
                        	case 1 :
                        	    // TypeChecker.g:70:16: t= type_decl
                        	    {
    ...
    // TypeChecker.g:75:1: type_decl returns [MiniType miniType = null] : ^(ast= STRUCT id= ID n= nested_decl[structType] ) ;
    public final MiniType type_decl() throws RecognitionException {
        ...
        try {
            // TypeChecker.g:78:4: ( ^(ast= STRUCT id= ID n= nested_decl[structType] ) )
            // TypeChecker.g:78:7: ^(ast= STRUCT id= ID n= nested_decl[structType] )
            {
    ...
    // TypeChecker.g:92:1: nested_decl[StructType structType] returns [MiniType miniType = null] : (f= field_decl[structType] )+ ;
    public final MiniType nested_decl(StructType structType) throws RecognitionException {
        ...
        try {
            // TypeChecker.g:95:4: ( (f= field_decl[structType] )+ )
            // TypeChecker.g:95:7: (f= field_decl[structType] )+
            {
            // TypeChecker.g:95:7: (f= field_decl[structType] )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // TypeChecker.g:95:8: f= field_decl[structType]
            	    {
    ...
    // TypeChecker.g:99:1: field_decl[StructType structType] returns [MiniType miniType = null] : ^( DECL ^( TYPE t= type ) id= ID ) ;
    public final MiniType field_decl(StructType structType) throws RecognitionException {
        ...
        try {
            // TypeChecker.g:101:4: ( ^( DECL ^( TYPE t= type ) id= ID ) )
            // TypeChecker.g:101:7: ^( DECL ^( TYPE t= type ) id= ID )
            {

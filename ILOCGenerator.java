// $ANTLR 3.5.2 ILOCGenerator.g 2015-05-03 21:03:37
...
public class ILOCGenerator extends TreeParser {
	...
	// ILOCGenerator.g:142:1: translate : ^( PROGRAM t= types d= declarations[null] f= functions ) ;
	public final void translate() throws RecognitionException {
		try {
			// ILOCGenerator.g:143:4: ( ^( PROGRAM t= types d= declarations[null] f= functions ) )
			// ILOCGenerator.g:143:7: ^( PROGRAM t= types d= declarations[null] f= functions )
			{
	...
	// $ANTLR start "types"
	// ILOCGenerator.g:149:1: types : ( ^( TYPES (t= type_decl )* ) |);
	public final void types() throws RecognitionException {
		  
		try {
			// ILOCGenerator.g:151:4: ( ^( TYPES (t= type_decl )* ) |)
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// ILOCGenerator.g:151:7: ^( TYPES (t= type_decl )* )
					{
					match(input,TYPES,FOLLOW_TYPES_in_types103); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// ILOCGenerator.g:151:15: (t= type_decl )*
						loop1:
						while (true) {
							int alt1=2;
							...
							switch (alt1) {
							case 1 :
								// ILOCGenerator.g:151:16: t= type_decl
								{
	...
	// ILOCGenerator.g:156:1: type_decl : ^(ast= STRUCT id= ID n= nested_decl[structType] ) ;
	public final void type_decl() throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:158:4: ( ^(ast= STRUCT id= ID n= nested_decl[structType] ) )
			// ILOCGenerator.g:158:7: ^(ast= STRUCT id= ID n= nested_decl[structType] )
			{
	...
	// ILOCGenerator.g:170:1: nested_decl[MiniType.StructType structType] : (f= field_decl[structType] )+ ;
	public final void nested_decl(MiniType.StructType structType) throws RecognitionException {
		MiniType f =null;

		  
		try {
			// ILOCGenerator.g:172:4: ( (f= field_decl[structType] )+ )
			// ILOCGenerator.g:172:7: (f= field_decl[structType] )+
			{
			// ILOCGenerator.g:172:7: (f= field_decl[structType] )+
			int cnt3=0;
			loop3:
			while (true) {
				...
				switch (alt3) {
				case 1 :
					// ILOCGenerator.g:172:8: f= field_decl[structType]
					{
	...
	// ILOCGenerator.g:175:1: field_decl[MiniType.StructType structType] returns [MiniType miniType = null] : ^( DECL ^( TYPE t= type ) id= ID ) ;
	public final MiniType field_decl(MiniType.StructType structType) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:177:4: ( ^( DECL ^( TYPE t= type ) id= ID ) )
			// ILOCGenerator.g:177:7: ^( DECL ^( TYPE t= type ) id= ID )
			{
	...
	// $ANTLR start "type"
	// ILOCGenerator.g:185:1: type returns [MiniType miniType = null] : ( INT | BOOL | ^( STRUCT id= ID ) );
	public final MiniType type() throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:187:4: ( INT | BOOL | ^( STRUCT id= ID ) )
			int alt4=3;
			switch ( input.LA(1) ) {
			case INT:
				{
			...
			switch (alt4) {
				...
				case 2 :
					...
					break;
				case 3 :
					// ILOCGenerator.g:189:7: ^( STRUCT id= ID )
					{
	...
	// ILOCGenerator.g:195:1: declarations[CFG cfg] : ( ^( DECLS (d= decl_list[cfg] )* ) |);
	public final void declarations(CFG cfg) throws RecognitionException {
		try {
			// ILOCGenerator.g:197:4: ( ^( DECLS (d= decl_list[cfg] )* ) |)
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// ILOCGenerator.g:197:7: ^( DECLS (d= decl_list[cfg] )* )
					{
					match(input,DECLS,FOLLOW_DECLS_in_declarations373); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// ILOCGenerator.g:197:15: (d= decl_list[cfg] )*
						loop5:
						while (true) {
							int alt5=2;
							...
							switch (alt5) {
							case 1 :
								// ILOCGenerator.g:197:16: d= decl_list[cfg]
								{
	...
	// ILOCGenerator.g:202:1: decl_list[CFG cfg] : ^( DECLLIST ^( TYPE t= type ) (id= ID )+ ) ;
	public final void decl_list(CFG cfg) throws RecognitionException {
		CommonTree id=null;
		MiniType t =null;

		try {
			// ILOCGenerator.g:203:4: ( ^( DECLLIST ^( TYPE t= type ) (id= ID )+ ) )
			// ILOCGenerator.g:203:7: ^( DECLLIST ^( TYPE t= type ) (id= ID )+ )
			{
	...
	// ILOCGenerator.g:215:1: functions returns [] : ( ^( FUNCS (f= function )* ) |);
	public final void functions() throws RecognitionException {
		  
		try {
			// ILOCGenerator.g:218:4: ( ^( FUNCS (f= function )* ) |)
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// ILOCGenerator.g:218:7: ^( FUNCS (f= function )* )
					{
					match(input,FUNCS,FOLLOW_FUNCS_in_functions503); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// ILOCGenerator.g:218:15: (f= function )*
						loop8:
						while (true) {
							int alt8=2;
							...
							switch (alt8) {
							case 1 :
								// ILOCGenerator.g:218:16: f= function
								{
	...
	// ILOCGenerator.g:243:1: function : ^(ast= FUN id= ID p= parameters[cfg] r= return_type d= declarations[cfg] s= statement_list[cfg, cfg.entryBlock] ) ;
	public final void function() throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:254:4: ( ^(ast= FUN id= ID p= parameters[cfg] r= return_type d= declarations[cfg] s= statement_list[cfg, cfg.entryBlock] ) )
			// ILOCGenerator.g:254:7: ^(ast= FUN id= ID p= parameters[cfg] r= return_type d= declarations[cfg] s= statement_list[cfg, cfg.entryBlock] )
			{
			...
			match(input, Token.UP, null); 
			         ...
			         else if (s != null && s.next.isEmpty()) {
			            s.next.add(exitBlock);
			            IInstruction.JUMPI jumpi = new IInstruction.JUMPI();
			            jumpi.label = exitBlock.label;
	...
	// ILOCGenerator.g:287:1: parameters[CFG cfg] returns [BasicBlock entryBlock = null] : ^( PARAMS (p= param_decl[] )* ) ;
	public final BasicBlock parameters(CFG cfg) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:294:4: ( ^( PARAMS (p= param_decl[] )* ) )
			// ILOCGenerator.g:294:7: ^( PARAMS (p= param_decl[] )* )
			{
			match(input,PARAMS,FOLLOW_PARAMS_in_parameters718); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// ILOCGenerator.g:294:16: (p= param_decl[] )*
				loop10:
				while (true) {
					int alt10=2;
					...
					switch (alt10) {
					case 1 :
						// ILOCGenerator.g:294:17: p= param_decl[]
						{
	...
	// ILOCGenerator.g:312:1: param_decl[] returns [String paramId = null] : ^( DECL ^( TYPE t= type ) id= ID ) ;
	public final String param_decl() throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:314:4: ( ^( DECL ^( TYPE t= type ) id= ID ) )
			// ILOCGenerator.g:314:7: ^( DECL ^( TYPE t= type ) id= ID )
			{
	...
	// ILOCGenerator.g:320:1: return_type : ^( RETTYPE (r= rtype ) ) ;
	public final void return_type() throws RecognitionException {
		try {
			// ILOCGenerator.g:321:4: ( ^( RETTYPE (r= rtype ) ) )
			// ILOCGenerator.g:321:7: ^( RETTYPE (r= rtype ) )
			{
			match(input,RETTYPE,FOLLOW_RETTYPE_in_return_type807); 
			match(input, Token.DOWN, null); 
			// ILOCGenerator.g:321:17: (r= rtype )
			// ILOCGenerator.g:321:18: r= rtype
			{
	...
	// $ANTLR start "rtype"
	// ILOCGenerator.g:324:1: rtype : (t= type | VOID );
	public final void rtype() throws RecognitionException {
		MiniType t =null;

		try {
			// ILOCGenerator.g:325:4: (t= type | VOID )
			int alt11=2;
	...
	// ILOCGenerator.g:329:1: statement[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : (s= block[cfg, block] |s= assignment[cfg, block] |s= print[cfg, block] |s= read[cfg, block] |s= conditional[cfg, block] |s= loop[cfg, block] |s= delete[cfg, block] |s= return_stmt[cfg, block] |s= invocation_stmt[cfg, block] ) ;
	public final BasicBlock statement(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:331:4: ( (s= block[cfg, block] |s= assignment[cfg, block] |s= print[cfg, block] |s= read[cfg, block] |s= conditional[cfg, block] |s= loop[cfg, block] |s= delete[cfg, block] |s= return_stmt[cfg, block] |s= invocation_stmt[cfg, block] ) )
			// ILOCGenerator.g:331:7: (s= block[cfg, block] |s= assignment[cfg, block] |s= print[cfg, block] |s= read[cfg, block] |s= conditional[cfg, block] |s= loop[cfg, block] |s= delete[cfg, block] |s= return_stmt[cfg, block] |s= invocation_stmt[cfg, block] )
			{
			// ILOCGenerator.g:331:7: (s= block[cfg, block] |s= assignment[cfg, block] |s= print[cfg, block] |s= read[cfg, block] |s= conditional[cfg, block] |s= loop[cfg, block] |s= delete[cfg, block] |s= return_stmt[cfg, block] |s= invocation_stmt[cfg, block] )
			int alt12=9;
			switch ( input.LA(1) ) {
			...
			switch (alt12) {
				case 1 :
					// ILOCGenerator.g:331:8: s= block[cfg, block]
					{
					...
					break;
				case 2 :
					// ILOCGenerator.g:332:10: s= assignment[cfg, block]
					{
					...
					break;
				case 3 :
					// ILOCGenerator.g:333:10: s= print[cfg, block]
					{
					...
					break;
				case 4 :
					// ILOCGenerator.g:334:10: s= read[cfg, block]
					{
					...
					break;
				case 5 :
					// ILOCGenerator.g:335:10: s= conditional[cfg, block]
					{
					...
					break;
				case 6 :
					// ILOCGenerator.g:336:10: s= loop[cfg, block]
					{
					...
					break;
				case 7 :
					// ILOCGenerator.g:337:10: s= delete[cfg, block]
					{
					...
					break;
				case 8 :
					// ILOCGenerator.g:338:10: s= return_stmt[cfg, block]
					{
					...
					break;
				case 9 :
					// ILOCGenerator.g:339:10: s= invocation_stmt[cfg, block]
					{
	...
	// $ANTLR start "block"
	// ILOCGenerator.g:344:1: block[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^( BLOCK s= statement_list[cfg, block] ) ;
	public final BasicBlock block(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:346:4: ( ^( BLOCK s= statement_list[cfg, block] ) )
			// ILOCGenerator.g:346:7: ^( BLOCK s= statement_list[cfg, block] )
			{
	...
	// ILOCGenerator.g:352:1: statement_list[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^( STMTS (s= statement[cfg, currentBlock] )* ) ;
	public final BasicBlock statement_list(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:355:4: ( ^( STMTS (s= statement[cfg, currentBlock] )* ) )
			// ILOCGenerator.g:355:7: ^( STMTS (s= statement[cfg, currentBlock] )* )
			{
			match(input,STMTS,FOLLOW_STMTS_in_statement_list1073); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// ILOCGenerator.g:355:15: (s= statement[cfg, currentBlock] )*
				loop13:
				while (true) {
					int alt13=2;
					...
					switch (alt13) {
					case 1 :
						// ILOCGenerator.g:355:16: s= statement[cfg, currentBlock]
						{
	...
	// ILOCGenerator.g:361:1: assignment[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= ASSIGN e= expression[cfg, block] l= lvalue[cfg, block, false] ) ;
	public final BasicBlock assignment(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:363:4: ( ^(ast= ASSIGN e= expression[cfg, block] l= lvalue[cfg, block, false] ) )
			// ILOCGenerator.g:363:7: ^(ast= ASSIGN e= expression[cfg, block] l= lvalue[cfg, block, false] )
			{
	...
	// $ANTLR start "print"
	// ILOCGenerator.g:389:1: print[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= PRINT e= expression[cfg, block] ( ENDL )? ) ;
	public final BasicBlock print(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:392:4: ( ^(ast= PRINT e= expression[cfg, block] ( ENDL )? ) )
			// ILOCGenerator.g:392:7: ^(ast= PRINT e= expression[cfg, block] ( ENDL )? )
			{
	...
	// $ANTLR start "read"
	// ILOCGenerator.g:401:1: read[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= READ l= lvalue[cfg, block, false] ) ;
	public final BasicBlock read(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:403:4: ( ^(ast= READ l= lvalue[cfg, block, false] ) )
			// ILOCGenerator.g:403:7: ^(ast= READ l= lvalue[cfg, block, false] )
			{
	...
	// ILOCGenerator.g:442:1: conditional[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= IF g= expression[cfg, guardBlock] t= block[cfg, thenBlock] (e= block[cfg, elseBlock] )? ) ;
	public final BasicBlock conditional(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:456:4: ( ^(ast= IF g= expression[cfg, guardBlock] t= block[cfg, thenBlock] (e= block[cfg, elseBlock] )? ) )
			// ILOCGenerator.g:456:7: ^(ast= IF g= expression[cfg, guardBlock] t= block[cfg, thenBlock] (e= block[cfg, elseBlock] )? )
			{
			...
			// ILOCGenerator.g:456:70: (e= block[cfg, elseBlock] )?
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// ILOCGenerator.g:456:71: e= block[cfg, elseBlock]
					{
	...
	// $ANTLR start "loop"
	// ILOCGenerator.g:495:1: loop[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= WHILE e= expression[cfg, guardBlock] b= block[cfg, bodyBlock] expression[cfg, new BasicBlock()] ) ;
	public final BasicBlock loop(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:506:4: ( ^(ast= WHILE e= expression[cfg, guardBlock] b= block[cfg, bodyBlock] expression[cfg, new BasicBlock()] ) )
			// ILOCGenerator.g:506:7: ^(ast= WHILE e= expression[cfg, guardBlock] b= block[cfg, bodyBlock] expression[cfg, new BasicBlock()] )
			{
	...
	// $ANTLR start "delete"
	// ILOCGenerator.g:532:1: delete[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= DELETE e= expression[cfg, block] ) ;
	public final BasicBlock delete(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:534:4: ( ^(ast= DELETE e= expression[cfg, block] ) )
			// ILOCGenerator.g:534:7: ^(ast= DELETE e= expression[cfg, block] )
			{
	...
	// ILOCGenerator.g:543:1: return_stmt[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^(ast= RETURN (e= expression[cfg, block] )? ) ;
	public final BasicBlock return_stmt(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:549:4: ( ^(ast= RETURN (e= expression[cfg, block] )? ) )
			// ILOCGenerator.g:549:7: ^(ast= RETURN (e= expression[cfg, block] )? )
			{
			ast=(CommonTree)match(input,RETURN,FOLLOW_RETURN_in_return_stmt1466); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// ILOCGenerator.g:549:20: (e= expression[cfg, block] )?
				int alt16=2;
				...
				switch (alt16) {
					case 1 :
						// ILOCGenerator.g:549:21: e= expression[cfg, block]
						{
	...
	// ILOCGenerator.g:563:1: invocation_stmt[CFG cfg, BasicBlock block] returns [BasicBlock resultBlock = null] : ^( INVOKE id= ID ^( ARGS (e= expression[cfg, block] )* ) ) ;
	public final BasicBlock invocation_stmt(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:570:4: ( ^( INVOKE id= ID ^( ARGS (e= expression[cfg, block] )* ) ) )
			// ILOCGenerator.g:570:7: ^( INVOKE id= ID ^( ARGS (e= expression[cfg, block] )* ) )
			{
			...
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// ILOCGenerator.g:574:17: (e= expression[cfg, block] )*
				loop17:
				while (true) {
					int alt17=2;
					...
					switch (alt17) {
					case 1 :
						// ILOCGenerator.g:574:18: e= expression[cfg, block]
						{
	...
	public final ILOCGenerator.lvalue_return lvalue(CFG cfg, BasicBlock block, boolean nested) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:605:4: (id= ID | ^(ast= DOT l= lvalue[cfg, block, true] id= ID ) )
			int alt18=2;
			...
			switch (alt18) {
				case 1 :
					...
					break;
				case 2 :
					// ILOCGenerator.g:631:7: ^(ast= DOT l= lvalue[cfg, block, true] id= ID )
					{
	...
	public final ILOCGenerator.expression_return expression(CFG cfg, BasicBlock block) throws RecognitionException {
		...
		try {
			// ILOCGenerator.g:667:4: ( ^( (ast= AND |ast= OR ) lft= expression[cfg, block] rht= expression[cfg, block] ) | ^( (ast= EQ |ast= LT |ast= GT |ast= NE |ast= LE |ast= GE ) lft= expression[cfg, block] rht= expression[cfg, block] ) | ^( (ast= PLUS |ast= MINUS |ast= TIMES |ast= DIVIDE ) lft= expression[cfg, block] rht= expression[cfg, block] ) | ^(ast= NOT e= expression[cfg, block] ) | ^(ast= NEG e= expression[cfg, block] ) | ^(ast= DOT e= expression[cfg, block] id= ID ) | ^( INVOKE id= ID ^( ARGS (e= expression[cfg, block] )* ) ) |id= ID |i= INTEGER |ast= TRUE |ast= FALSE | ^(ast= NEW id= ID ) |ast= NULL )
			int alt23=13;
			switch ( input.LA(1) ) {
			case AND:
			case OR:
			...
			switch (alt23) {
				case 1 :
					// ILOCGenerator.g:667:7: ^( (ast= AND |ast= OR ) lft= expression[cfg, block] rht= expression[cfg, block] )
					{
					// ILOCGenerator.g:667:9: (ast= AND |ast= OR )
					int alt19=2;
					...
					switch (alt19) {
						case 1 :
							// ILOCGenerator.g:667:10: ast= AND
							{
							ast=(CommonTree)match(input,AND,FOLLOW_AND_in_expression1694); 
							}
							break;
						case 2 :
							// ILOCGenerator.g:667:20: ast= OR
							{
					...
					break;
				case 2 :
					// ILOCGenerator.g:691:7: ^( (ast= EQ |ast= LT |ast= GT |ast= NE |ast= LE |ast= GE ) lft= expression[cfg, block] rht= expression[cfg, block] )
					{
					// ILOCGenerator.g:691:9: (ast= EQ |ast= LT |ast= GT |ast= NE |ast= LE |ast= GE )
					int alt20=6;
					switch ( input.LA(1) ) {
					case EQ:
						{
					...
					break;
				case 3 :
					// ILOCGenerator.g:750:7: ^( (ast= PLUS |ast= MINUS |ast= TIMES |ast= DIVIDE ) lft= expression[cfg, block] rht= expression[cfg, block] )
					{
					// ILOCGenerator.g:750:9: (ast= PLUS |ast= MINUS |ast= TIMES |ast= DIVIDE )
					int alt21=4;
					switch ( input.LA(1) ) {
					case PLUS:
						{
					...
					break;
				case 4 :
					// ILOCGenerator.g:786:7: ^(ast= NOT e= expression[cfg, block] )
					{
					...
					break;
				case 5 :
					// ILOCGenerator.g:795:7: ^(ast= NEG e= expression[cfg, block] )
					{
					...
					break;
				case 6 :
					// ILOCGenerator.g:808:7: ^(ast= DOT e= expression[cfg, block] id= ID )
					{
					...
					break;
				case 7 :
					// ILOCGenerator.g:823:7: ^( INVOKE id= ID ^( ARGS (e= expression[cfg, block] )* ) )
					{
					...
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						// ILOCGenerator.g:827:14: (e= expression[cfg, block] )*
						loop22:
						while (true) {
							int alt22=2;
							...
							switch (alt22) {
							case 1 :
								// ILOCGenerator.g:827:15: e= expression[cfg, block]
								{
				...
				case 8 :
					...
					break;
				case 9 :
					// ILOCGenerator.g:870:7: i= INTEGER
					{
					...
					break;
				case 10 :
					// ILOCGenerator.g:878:7: ast= TRUE
					{
					...
					break;
				case 11 :
					// ILOCGenerator.g:886:7: ast= FALSE
					{
					...
					break;
				case 12 :
					// ILOCGenerator.g:894:7: ^(ast= NEW id= ID )
					{
					...
					break;
				case 13 :
					// ILOCGenerator.g:903:7: ast= NULL
					{

...
public class Register {
   ...
   public static final Set<Register> REQUIRED_REGISTERS = Collections.unmodifiableSet(new HashSet<Register>(Arrays.asList(RDI, RSI, RDX, RCX, R8, R9, R10, R11, RSP, RBP, RAX)));
   ...
   public static final Set<Register> CALLEE_SAVED = Collections.unmodifiableSet(new HashSet<Register>(Arrays.asList(RBX, R12, R13, R14, R15)));
}
FILES=Mini.java MiniType.java IInstruction.java Register.java X86Mapper.java RegisterAllocator.java CFG.java BasicBlock.java RegisterAllocaterTester.java Node.java InterferenceGraph.java
